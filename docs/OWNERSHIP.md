...
| S3 | W2 | `server/vendor/pipeline-engine/packages/web/src/components/workflows/NodeInspector.tsx` | remove '.archon/mcp/github.json' and every archon-branded placeholder/label |
...
| S3 | W2 | `server/vendor/pipeline-engine/packages/web/src/components/workflows/QuickAddPicker.tsx` | quick-add: harness pre-selection; no archon placeholders |
