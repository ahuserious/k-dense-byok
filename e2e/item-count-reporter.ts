...
const EXPECTED_ITEMS_BY_FILE = new Map([
  ...
  // Lane F6 (Wave F): rows 19/22/25/33 on the builder Compose surface.
  // Path-keyed to dest's inventoryKey (relative to e2e/), not basename.
  ["wave-f/f6/compose.spec.ts", 9],
  ...
  ["wave-f/f7/pipeline-builder-skill.spec.ts", 6],
...
// F11 adds 3. F1 adds 7. F3 adds 2. F7 adds 14. F6 compose.spec.ts (9).
const EXPECTED_SUBSTANTIVE_ITEMS = 312;
