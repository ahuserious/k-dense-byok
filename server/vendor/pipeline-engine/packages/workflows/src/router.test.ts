  ...
  describe('resolveWorkflowName', () => {
    ...
    it('should return suffix match', () => {
      const workflows: WorkflowDefinition[] = [
        { name: 'pipeline-assist', description: 'General assistant', nodes: [] },
      ];
      const result = resolveWorkflowName('assist', workflows);
      expect(result?.name).toBe('pipeline-assist');
    });

    it('should return substring match', () => {
      const workflows: WorkflowDefinition[] = [
        { name: 'pipeline-smart-pr-review', description: 'Smart PR review', nodes: [] },
      ];
      const result = resolveWorkflowName('smart', workflows);
      expect(result?.name).toBe('pipeline-smart-pr-review');
    });
    ...
    it('should throw on ambiguous suffix match', () => {
      const workflows: WorkflowDefinition[] = [
        { name: 'pipeline-review', description: 'Review', nodes: [] },
    ...
    it('should prefer exact match over suffix match', () => {
      const workflows: WorkflowDefinition[] = [
        ...
        { name: 'pipeline-assist', description: 'Long name', nodes: [] },
      ];
      const result = resolveWorkflowName('assist', workflows);
    ...
    it('should prefer suffix match over substring match', () => {
      const workflows: WorkflowDefinition[] = [
        { name: 'pipeline-assist', description: 'Suffix match', nodes: [] },
        { name: 'assist-helper', description: 'Substring match', nodes: [] },
      ];
      const result = resolveWorkflowName('assist', workflows);
      // "assist" is a suffix of "pipeline-assist" (ends with -assist)
