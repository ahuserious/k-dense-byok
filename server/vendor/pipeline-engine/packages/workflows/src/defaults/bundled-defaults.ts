 ...
 *
 * Content lives in `bundled-defaults.generated.ts`. Kady intentionally keeps
 * both records empty because its scientific workflow library owns app defaults.
 * This hand-written facade re-exports the records and defines the binary helper.
 *
 * Why two files:
