/**
 * Configuration loader for Pipeline Engine YAML config files
 *
 ...
 */
const DEFAULT_CONFIG_CONTENT = `# Pipeline Engine Global Configuration
# Documentation: use Kady Settings and the repository documentation.
...
function applyEnvOverrides(
  ...
  // Path overrides (these come from pipeline-paths.ts which already checks env vars)
