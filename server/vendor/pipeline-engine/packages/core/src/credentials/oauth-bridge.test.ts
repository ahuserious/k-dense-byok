...
// bridge maps Pipeline Engine providers to (claude→anthropic, codex→openaiCodex, copilot→…).
type Callbacks = {
...
// The openai (ChatGPT/Codex) flow is Pipeline Engine-owned (#1924) — drive its exchange
...
describe('oauth-bridge', () => {
  ...
  // ---- #1924: openai (ChatGPT/Codex) runs the Pipeline Engine-owned PKCE flow ----
