 ...
 * - `openai` (ChatGPT/Codex): an Pipeline Engine-OWNED PKCE flow (`openai-oauth.ts`)
 ...
 *   refresh path to the Pipeline Engine flow.
 */
import {
...
/** The vendor whose subscription flow is Pipeline Engine-owned (see header + #1924). */
 ...
 * agent-keyed), or undefined if its flow is not Pi-driven (`openai` — Pipeline Engine
