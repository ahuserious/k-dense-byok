...
// The openai vendor refreshes through the Pipeline Engine-owned flow (NOT Pi's
...
describe('user-provider-key-store', () => {
  ...
  describe('getDecryptedProviderCredential', () => {
    ...
    // ---- openai: Pipeline Engine-owned refresh path (#1924) ----
    ...
    test('openai oauth row → routes through the Pipeline Engine flow, NOT Pi getOAuthApiKey (#1924)', async () => {
      mockGetOAuthApiKey.mockClear();
