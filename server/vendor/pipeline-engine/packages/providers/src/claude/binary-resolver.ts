/**
 * Claude Code CLI resolver for compiled (bun --compile) pipeline engine binaries.
 *
...
const INSTALL_INSTRUCTIONS =
  'Claude Code not found. Pipeline Engine requires the Claude Code executable to be\n' +
  'reachable at a configured path in compiled builds.\n\n' +
  'To fix, install Claude Code and point Pipeline Engine at it:\n\n' +
  ...
  'See the pipeline-engine configuration reference.';
