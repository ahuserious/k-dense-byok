...
export interface ClaudeProviderDefaults {
   ...
   *  Pipeline Engine builds when `CLAUDE_BIN_PATH` is not set; optional in dev mode
...
export interface CodexProviderDefaults {
  ...
  /** Path to the Codex CLI binary. Overrides auto-detection in compiled Pipeline Engine builds. */
...
export interface CopilotProviderDefaults {
  ...
  /**
   * Absolute path to the Copilot CLI binary. Required in compiled Pipeline Engine
...
export interface PiProviderDefaults {
   ...
   * that repo ships. Disabled by default to preserve the "Pipeline Engine is source of
...
export interface ProviderCapabilities {
   ...
   *    OpenCode). The request path is native; Pipeline Engine still validates post-parse
