 ...
 * Claude's SDK and Pi's default resource loader both respect, so Pipeline Engine
 ...
 * Pipeline Engine runs out of a subdirectory.
 */
...
/**
 * Resolve Pipeline Engine's name-based `skills:` nodeConfig references to absolute
