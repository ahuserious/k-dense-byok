 ...
 * `modelName` so they sit alongside Pipeline Engine's other `remote_agent_*` tables. The
 * CANONICAL Pipeline Engine user stays `remote_agent_users`; a Better Auth session is
