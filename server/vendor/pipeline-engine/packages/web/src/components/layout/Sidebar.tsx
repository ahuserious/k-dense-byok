...
const STORAGE_KEY = 'pipeline-sidebar-width';
    ...
    >
      ...
      <div className="flex flex-col gap-3 p-4">
        <Link to="/legacy" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <img src="/kdense-logo.png" alt="" aria-hidden="true" className="h-8 w-8 rounded-lg object-contain" />
          <span className="text-base font-semibold text-text-primary">Pipeline Builder</span>
        </Link>
      </div>
