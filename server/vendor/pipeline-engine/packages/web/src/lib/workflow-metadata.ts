...
export function parseWorkflowDescription(description: string): ParsedDescription {
  ...
  // Fallback: "Handles:" (e.g., pipeline-assist)
  if (!result.whenToUse) {
  ...
  // Fallback: "Capability:" (e.g., pipeline-assist)
  if (!result.does) {
