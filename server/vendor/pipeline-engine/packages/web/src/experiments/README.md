...
- `console/builder/` — Pipeline Engine Studio workflow-builder data layer (types, variant registry, round-trip model, validation). PR-1 of the builder chain; no route mount yet — canvas (PR-2) and persistence (PR-3) follow.
