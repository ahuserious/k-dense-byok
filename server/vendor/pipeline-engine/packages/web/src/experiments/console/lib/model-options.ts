...
// ship models faster than Pipeline Engine can enumerate them, so every consumer keeps a
...
export const CLAUDE_MODEL_OPTIONS: readonly ModelOption[] = [
  { value: 'claude-opus-4-8[1m]', hint: '1M context · default' },
...
/**
 * Copilot model list. PROVENANCE: no Pipeline Engine API exposes Copilot's model
