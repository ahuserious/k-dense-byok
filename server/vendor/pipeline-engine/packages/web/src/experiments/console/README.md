...
A greenfield spike of Pipeline Engine's web UI built around four primitives:
...
In progress: the `builder/` subtree (Pipeline Engine Studio workflow builder). PR-1
