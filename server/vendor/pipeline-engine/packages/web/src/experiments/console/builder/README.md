...
`pipeline-workflow-studio` as part of the Pipeline Engine Studio integration
(upstream issue #1863; provenance is recorded in the repository attribution file).
