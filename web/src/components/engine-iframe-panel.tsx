// danbot-byok — web/src/components/engine-iframe-panel.tsx
//
// Shared full-bleed iframe panel for the local engines Kady embeds (the workflow
...
export function EngineIframePanel({
  src,
  title,
  healthCheck,
  engineLabel = "engine",
