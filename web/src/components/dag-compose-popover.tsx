...
// lib/use-skills (the target's skills-selector does not export it) and the Workflow
// catalogue is the target's own data/workflows.json (same shape, more fields).
